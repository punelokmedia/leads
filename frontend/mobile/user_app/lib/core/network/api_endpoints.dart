...
class ApiEndpoints {
  ...
  static const String _cities = '$_apiV1/cities';
  static const String getAllCities = '$_cities/get-all-cities';
  ...
  static String downloadLead(String internalOrderId) =>
      '$_apiV1/leads/download/$internalOrderId';
}
